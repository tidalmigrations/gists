...
module AzureMigrate
  ...
  def list_assessment_projects
    ...
    path = "https://management.azure.com/subscriptions/#{subscription}/resourceGroups/#{resource_group}/providers/Microsoft.Migrate/assessmentProjects?api-version=#{version}"
